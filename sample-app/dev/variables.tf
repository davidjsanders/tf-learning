...
variable "vnet_group" {
  description = "The parent VNET group where the subnet will be created"
  default     = "lcl_prove_vnet_rg"
}

variable "vnet_name" {
  description = "The parent VNET where the subnet will be created"
  default     = "lcl_prove_open_vnet"
}
...
variable "nsg_name" {
  ...
  default     = "sample-app-subnet-1-nsg"
}
